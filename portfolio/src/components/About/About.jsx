  ...
  return (
    ...
    <div className={style.contenedor}>
      {lang ? <div className={style.card}>
        ...
        At age 25, I went through a shocking event that transformed my path. In search of answers and emotional refuge, I stumbled upon a video about computer logic on my social network. Logic became my lighthouse, a constant guide that took me to the fascinating world of programming in which I learned to use technologies such as:<br/>HTML, CSS, JAVA SCRIPT, REACT, REDUX, EXPRESS, NODE JS, GITHUB, GIT, SEQUELIZE && SQL<br/><br/>
